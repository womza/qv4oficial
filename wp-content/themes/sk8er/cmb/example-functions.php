...
function cmb_sample_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes['page_options'] = array(
		'id'         => 'page_options',
		'title'      => __( 'Page Revolution Slider', 'sk8er' ),
	...
	$meta_boxes['pagelinks_option'] = array(
		...
		'title'      => __( 'Page Link options', 'sk8er' ),
	...
	$meta_boxes['blog_options'] = array(
		...
		'fields'     => array(
			array(
				'name'    => __( 'Blog Columns', 'sk8er' ),
				'desc'    => __( 'Select how much columns should be on Blog Page.', 'sk8er' ),
			...
			array(
				'name'    => __( 'Layout', 'sk8er' ),
				'desc'    => __( 'In what Layout should posts be. Blog Columns doesn\'t affect on Grid Layout.', 'sk8er' ),
				'id'      => $prefix . 'blog_layout',
				'type'    => 'select',
				'options' => array(
					'normal' 				=> __( 'Normal', 'sk8er' ),
					'grid'   				=> __( 'Grid', 'sk8er' ),
				),
			),
			array(
	...
	$meta_boxes['portfolio_options'] = array(
		...
		'title'      => __( 'Portfolio options', 'sk8er' ),
		'pages'      => array( 'page', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		...
		'fields'     => array(
			array(
				'name'    => __( 'Columns', 'sk8er' ),
				'desc'    => __( 'Select how much columns should be on Portfolio Page.', 'sk8er' ),
			...
			array(
				'name'    => __( 'Layout', 'sk8er' ),
				'desc'    => __( 'In what Layout should posts be. Columns doesn\'t affect on Grid Layout.', 'sk8er' ),
	...
	$meta_boxes['portfolio_messy_options'] = array(
		...
		'title'      => __( 'Messy Portfolio Options', 'sk8er' ),
		'pages'      => array( 'page', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
	...
	$meta_boxes['single_portfolio_options'] = array(
		...
		'fields'     => array(
			...
			array(
				'name'    => __( 'Images Layout', 'sk8er' ),
				'desc'    => __( 'In what Layout should images be. If <b>is slider</b>, then this won\'t affect on layout.', 'sk8er' ),
				'id'      => $prefix . 'portfolio_images_layout',
				'type'    => 'select',
				'options' => array(
					'normal' 				=> __( 'Normal (in content)', 'sk8er' ),
					'grid'   				=> __( 'Grid (above content)', 'sk8er' ),
					'grid2'   				=> __( 'Grid 2 (above content)', 'sk8er' ),
					'fullwidth'   			=> __( 'Full Width (above content)', 'sk8er' ),
				),
			),
			array(
			    'name' => 'Client Name',
	...
	$meta_boxes['single_event_options'] = array(
		...
		'title'      => __( 'Event Info <small style="color: #888;display:block;"><i>Everything below is required in order for layout to show properly.</i></small>', 'sk8er' ),
	...
	$meta_boxes['tabs_section'] = array(
		'id'         => 'tabs_section',
		'title'      => __( 'Wine Tabs Section', 'sk8er' ),
		'pages'      => array( 'page', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
	...
	$meta_boxes['single_wine_options'] = array(
		...
		'title'      => __( 'Wine Post Options', 'sk8er' ),
	...
	$meta_boxes['single_services_options'] = array(
		...
		'title'      => __( 'Services Post Options', 'sk8er' ),
	...
	$meta_boxes['single_shop_news_options'] = array(
		...
		'title'      => __( 'Shop News Post Options', 'sk8er' ),
	...
	$meta_boxes['post_link_options'] = array(
		...
		'title'      => __( 'Link Post Options', 'sk8er' ),
		'pages'      => array( 'post', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
	...
	$meta_boxes['post_audio_options'] = array(
		...
		'title'      => __( 'Audio Post Options', 'sk8er' ),
		'pages'      => array( 'post', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
	...
	$meta_boxes['single_pricing_options'] = array(
		...
		'fields'     => array(
			...
			array(
				'name'    => __( 'Paying Period', 'sk8er' ),
				'desc'    => __( '', 'sk8er' ),
				'id'      => $prefix . 'pricing_package_paying_period',
				'type'    => 'select',
				'options' => array(
					'hourly'   		=> __( 'Hourly', 'sk8er' ),
					'daily'   		=> __( 'Daily', 'sk8er' ),
					'month' 		=> __( 'Month', 'sk8er' ),
					'year'   		=> __( 'Year', 'sk8er' ),
				),
			),
			array(
	...
	$meta_boxes['funfacts_options'] = array(
		'id'         => 'funfacts_options',
		'title'      => __( 'Fun Facts options', 'sk8er' ),
