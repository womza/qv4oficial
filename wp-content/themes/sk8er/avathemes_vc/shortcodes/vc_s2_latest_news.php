...
class WPBakeryShortCode_vc_s2_latest_news extends  WPBakeryShortCode
{
    public function content($atts, $content = null)
    {
        ...
        <?php
            list($args, $posts_query) = vc_build_loop_query($posts_query);
            $quickview_wp_query = clone $posts_query;
        ?>
    ...
    "params"    => array(
        ...
        array(
            ...
            'settings' => array(
                ...
                'size' => array('value' => 3, 'hidden' => true)
            ),
            "description" => __("Create WordPress loop, to populate posts from your site.", 'js_composer')
        ),
    )
);
