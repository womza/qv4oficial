...
class WPBakeryShortCode_vc_s1_latest_news extends  WPBakeryShortCode
{
    public function content($atts, $content = null)
    {
        ...
        <?php if ( $wp_query->have_posts() ) : ?>
            ...
            <section class="style-1 latest-news">
                <div class="inner">
                                    ...
                                    <div class="block">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="author-info">
                                                <i class="fa fa-user"></i> <?php echo _e( 'por', 'sk8er'); ?> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author_meta( 'display_name' ); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
$opts = array(
    ...
    "base"      => "vc_s1_latest_news",
    "class"     => "vc_s1_latest_news",
    "icon"      => "icon-class",
    "controls"  => "full",
