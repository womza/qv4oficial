                        ...
                        <div class="row contact-info">
                            ...
                            <?php endif ?>
                                ...
                                <div class="row contact-more-info">
                                    ...
                                    <?php if (isset($sk8er['sk8er_contact_info_1'][0])): ?>
                                        <div class="col-sm-6">
                                            <div class="box">
                                    ...
                                    <?php if (isset($sk8er['sk8er_contact_info_2'][0])): ?>
                                        <div class="col-sm-6">
                                            <div class="box">
                                    ...
                                    <?php if (isset($sk8er['sk8er_contact_info_3'][0])): ?>
                                        <div class="col-sm-6">
                                            <div class="box">
                                    ...
                                    <?php if (isset($sk8er['sk8er_contact_info_4'][0])): ?>
                                        <div class="col-sm-6">
                                            <div class="box">
