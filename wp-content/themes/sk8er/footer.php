...
?>
        ...
        <?php if (!is_page_template('templates/template-full-page.php') && !is_page_template('templates/template-shop-news.php') && $footer_widget==1 && $footer_style!=3): ?>
            <?php
                ...
                $shortcode_feed = $sk8er['sk8er_footer_shortcode_feed'];
            ?>
                ...
                <div class="container">
                    ...
                    <?php if ($wp_query->have_posts()): ?>
                        <div class="col-md-4 block">
                            <div class="name"><?php _e( 'Latest Posts' , 'sk8er' ); ?></div>
                    ...
                    <?php if (!empty($instagram_user)): ?>
                        ...
                        <div class="col-md-4 block">
                            <div class="name"><?php _e('Instagram Feed', 'sk8er'); ?></div>
                    ...
                    <?php if (empty($instagram_user) && !empty($shortcode_feed)): ?>
                        <div class="col-md-4 block">
                            <?php echo do_shortcode($shortcode_feed); ?>
                        </div>
                    <?php endif ?>
