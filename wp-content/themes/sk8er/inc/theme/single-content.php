								...
								<div class="post-text">
									...
									<?php if ('quote' == get_post_format()): ?>
										...
										<?php elseif('audio' == get_post_format()): ?>
											<?php $gpm_audio = get_post_meta( $post->ID, 'sk8er_audio_id'); ?>
											<?php if (isset($gpm_audio)): ?>
												<?php $audio_id = get_post_meta( $post->ID, 'sk8er_audio_id'); ?>

												<?php if (!empty($audio_id[0])): ?>
													<iframe width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/<?php echo esc_attr($audio_id[0]); ?>&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
												<?php endif ?>
										...
										<?php elseif('link'	== get_post_format()): ?>
											<?php $link = get_post_meta( $post->ID, 'sk8er_link_url'); ?>
											<?php if (isset($link)): ?>
												<a href="<?php echo esc_url($link[0]); ?>" target="_blank"><b><?php _e( 'Visit Link!' , 'sk8er' ) ?></b></a>
